...
source <(curl -fsSL https://raw.githubusercontent.com/KiroFyzu/KiHost-VM/main/misc/core.func)
source <(curl -fsSL https://raw.githubusercontent.com/KiroFyzu/KiHost-VM/main/misc/tools.func)
source <(curl -fsSL https://raw.githubusercontent.com/KiroFyzu/KiHost-VM/main/misc/error_handler.func)
source <(curl -fsSL https://raw.githubusercontent.com/KiroFyzu/KiHost-VM/main/misc/api.func) 2>/dev/null || true
...
type=update bash -c "$(curl -fsSL https://raw.githubusercontent.com/KiroFyzu/KiHost-VM/main/tools/addon/prometheus-paperless-ngx-exporter.sh)"
UPDATEEOF
