...
ADDON_SCRIPT="https://raw.githubusercontent.com/KiroFyzu/KiHost-VM/main/tools/addon/coolify.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/KiroFyzu/KiHost-VM/main/tools/addon/coolify.sh)"
MIGRATION_EOF
