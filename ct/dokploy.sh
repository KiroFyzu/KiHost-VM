#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/KiroFyzu/KiHost-VM/main/misc/build.func)
...
ADDON_SCRIPT="https://raw.githubusercontent.com/KiroFyzu/KiHost-VM/main/tools/addon/dokploy.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/KiroFyzu/KiHost-VM/main/tools/addon/dokploy.sh)"
MIGRATION_EOF
